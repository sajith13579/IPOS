...
Public Class frmRateQtyItemLog
    ...
    Private Sub BtnPrintqua_Click(sender As Object, e As EventArgs) Handles BtnPrintqua.Click
        Dim fromDate As Date = dtpDateFromQua.Value
        Dim toDate As Date = dtpDateToQua.Value
        If txtBillNumberQua.Text = "" Then
    ...
    Public Sub print_btn_RT_chg_enb_dis_qua()
        If DatagridView1.Rows.Count > 0 Then
            ...
            ToolTip1.SetToolTip(BtnPrint, "No data please choose any type of filter")
            ToolTip1.SetToolTip(btnExportExcel, "No data please choose any type of filter")
